...
3번 정점에서 **방문하지 않은 정점이 없으므로**, 이전 정점인 **4번 정점으로 되돌아간다.**

![](https://github.com/user-attachments/assets/dd166840-59d0-4261-80d2-1fb30962a137)

4번 정점에서도 더 이상 방문할 정점이 없으므로 **2번 정점으로 되돌아간다.**
...
이와 같이 DFS는 한 경로를 가능한 한 깊게 탐색한 뒤, 더 이상 이동할 수 없을 때 이전 정점으로 되돌아가며 탐색을 계속하는 방식으로 동작한다.
