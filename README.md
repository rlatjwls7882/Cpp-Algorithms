...
* 그래프
  ...
  * 방향 비순환 그래프
    * Kahn’s Algorithm 🟡 Gold III
  * 최소 신장 트리
    * Kruskal’s Algorithm 🟡 Gold IV
  * 유량
    * Kuhn's Algorithm 🟢 Platinum IV
...
* 수학
  * 정수론
    ...
    * Exponentiation by Squaring (분할 정복을 이용한 거듭제곱) ⚪ Silver I
    * Modular Multiplicative Inverse (모듈러 곱셈의 역원) 🟡 Gold I
  * 기하학
    * CCW (Counter-ClockWise) 🟡 Gold V
    * Line Intersection (선분 교차 판정) 🟡 Gold II
    * Graham's Scan 🟢 Platinum V
